      ...
      <div className="bg-black my-14 lg:my-24 p-5 md:p-10 lg:p-16 flex flex-col lg:flex-row lg:items-center">
        <div className="order-1 w-full lg:order-1 lg:w-1/2">
          ...
          <div className="flex flex-row items-center gap-3">
            <div className="w-16 h-16 md:h-16  rounded-full bg-white flex flex-col items-center justify-center">
              <h1 className="text-sm md:text-base font-extrabold">5</h1>
              <p className="text-xs mt-0">Days</p>
            </div>
            <div className="w-16 h-16 md:h-16  rounded-full bg-white flex flex-col items-center justify-center">
              <h1 className="text-sm md:text-base font-extrabold">23</h1>
              <p className="text-xs mt-0">Hours</p>
            </div>
            <div className="w-16 h-16 md:h-16 rounded-full bg-white flex flex-col items-center justify-center">
              <h1 className="text-sm md:text-base font-extrabold">59</h1>
              <p className="text-xs mt-0">Minutes</p>
            </div>
            <div className="w-16 h-16 md:h-16 rounded-full bg-white flex flex-col items-center justify-center">
              <h1 className="text-sm md:text-base font-extrabold">32</h1>
