...
const CarouselComponent = () => {
  ...
  return (
    <Slider {...settings}>
      ...
      <div>
        <div className="bg-gradient-to-l from-blue-800 via-blue-700 to-blue-600 flex flex-row items-center justify-center text-white px-6 py-9 md:py-9 md:px-14 lg:py-14 lg:px-20">
          <div className="w-1/2">
            <div className="flex flex-row items-center gap-4">
              <h1 className="text-xs md:text-base lg:font-semibold">
      ...
      <div>
        <div className="bg-gradient-to-r from-yellow-500 via-yellow-400 to-yellow-300 flex flex-row items-center justify-center text-white px-6 py-9 md:py-9 md:px-14 lg:py-14 lg:px-20">
          <div className="w-1/2">
            <div className="flex flex-row items-center gap-4">
