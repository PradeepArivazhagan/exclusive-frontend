...
const MainHeader = () => {
  ...
  return (
    <header className="fixed z-10 bg-white w-full pt-5 pb-4 lg:pt-6 lg:pb-5 border-b border-slate-300">
      ...
      {isClickAccount && (
        <ul className="bg-white py-2 top-36  right-44 mt-2 absolute shadow-xl flex flex-col md:hidden lg:hidden items-start text-base rounded-md">
          ...
          >
            ...
            <div className="w-3/4">
              <h1 className="text-sm">My Order</h1>
            </div>
          </Link>
          <Link
            to="/account"
          ...
          >
            ...
            <div className="w-3/4">
              <h1 className="text-sm">Cancellations</h1>
            </div>
          </Link>
          <Link
            to="/account"
      ...
      {isClickAccount && (
        <ul className="bg-white py-2  right-28 mt-2 absolute shadow-xl hidden md:hidden lg:flex flex-col items-start text-base rounded-md">
          <Link
            to="/account"
            className="w-full py-2 px-10 hover:bg-slate-100 rounded-sm flex flex-row items-center justify-center gap-3"
          >
            <div className="">
              {" "}
              <svg
